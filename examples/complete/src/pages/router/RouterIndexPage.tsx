  ...
  render() {
    return (
      <div class="space-y-12">
        ...
        <div class="space-y-4">
          <div>
            <h3 class="mb-1 text-base font-medium text-gray-800">路由配置</h3>
            ...
            <DemoBox fukict:slot="demo">
              <div class="space-y-3 text-sm text-gray-700">
                <div class="rounded border border-blue-200 bg-blue-50 p-3">
                  <p class="mb-1 font-medium text-blue-900">嵌套路由</p>
                  <p class="text-xs text-blue-700">
                    使用 children 定义子路由，实现多层页面结构
                  </p>
                </div>
                <div class="rounded border border-green-200 bg-green-50 p-3">
                  <p class="mb-1 font-medium text-green-900">动态参数</p>
                ...
                <div class="rounded border border-purple-200 bg-purple-50 p-3">
                  <p class="mb-1 font-medium text-purple-900">重定向</p>
        ...
        <RouterView router={this.router} />
            ...
            <DemoBox fukict:slot="demo">
              <div class="space-y-4">
                ...
                {/* 子路由出口 */}
                <div class="min-h-[150px] rounded-lg border border-gray-200 bg-white p-3">
                  <RouterView router={this.router} />
                </div>
              </div>
            </DemoBox>
          ...
          跳转到用户 789
            ...
            <DemoBox fukict:slot="demo">
              <div class="space-y-3 text-sm text-gray-700">
                ...
                <div class="rounded border border-green-200 bg-green-50 p-3">
                  <p class="mb-1 font-medium text-green-900">
                    this.route.query
                  </p>
                  <p class="text-xs text-green-700">
                ...
                <div class="rounded border border-orange-200 bg-orange-50 p-3">
                  <p class="mb-1 font-medium text-orange-900">this.push()</p>
      ...
      <div>
        ...
        <RouterView router={this.router} />
            ...
            <DemoBox fukict:slot="demo">
              <div class="space-y-3 text-sm text-gray-700">
                <div class="rounded border border-blue-200 bg-blue-50 p-3">
                  <p class="mb-1 font-medium text-blue-900">多层 RouterView</p>
                  <p class="text-xs text-blue-700">
                    父路由和子路由都可以使用 RouterView 创建嵌套结构
                  </p>
                </div>
                <div class="rounded border border-green-200 bg-green-50 p-3">
                  <p class="mb-1 font-medium text-green-900">路由匹配</p>
                  <p class="text-xs text-green-700">
                    路由器自动匹配最深层的路由并渲染对应组件
                  </p>
                </div>
                <div class="rounded border border-purple-200 bg-purple-50 p-3">
                  <p class="mb-1 font-medium text-purple-900">共享布局</p>
                  <p class="text-xs text-purple-700">
                    父组件提供共享的导航、侧边栏等布局元素
                  </p>
                </div>
        ...
        <div class="space-y-4">
          ...
          <div class="grid grid-cols-2 gap-4">
            ...
            <div class="rounded-lg border border-green-200 bg-green-50 p-4">
              <h4 class="mb-2 text-sm font-medium text-green-900">Link 组件</h4>
